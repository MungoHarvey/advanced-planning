#!/bin/sh
# uninstall.sh — remove what install.sh installed for OpenCode, and nothing else.
#
# Usage:
...
for skill in approved_skills:
    ...
    # Remove "opencode" from owners - mutate data directly
    if "opencode" in owners:
        owners = [o for o in owners if o != "opencode"]
...
uninstall_from() {
    ...
    echo ""
    echo "Removing OpenCode Advanced Planning adapter from:"
